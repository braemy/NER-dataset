...
NATIONALITY_IS_CAP = { #like in English
    "en"
}

NATIONALITY_DO_NOT_NEED_TO_BE_CAP = { #like in german, french, italian
    "de",
    "fr",
    "it"
}
...
TITLE_ABBRS_DE = {"Hr.", "Fr", "Prof.", "Dr.", "Frl.", "Herr", "Herren" ,"Herrn", "Frau", "Frauen",
"Professor", "Professorin", "Professoren", "Professorinnen", "Doktor", "Doktors", "Doktoren",
"Fräulein", "Fräuleins", "Papst", "Papsten", "Pfarrer"}
